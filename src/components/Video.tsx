            ...
            <div className="p-8 max-w-[1100] mx-auto">
                <div className="flex items-start gap-16">
                    ...
                    <div  className="flex flex-col gap-4">
                        ...
                        <a href="#" className="p-4 text-sm border border-blue-500 text-blue-500 flex items-center rounded font-bold uppercase gap-2 justify-center hover:text-gray-950 hover:bg-blue-500 transition-colors">
                            <Lightning size={24}/>
                            Acesso ao desafio
                        </a>
