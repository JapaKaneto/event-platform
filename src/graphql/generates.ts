...
export type CreteSubscribeMutationVariables = Exact<{
  name: Scalars['String']['input'];
  email: Scalars['String']['input'];
}>;


export type CreteSubscribeMutation = { __typename?: 'Mutation', createSubscriber?: { __typename?: 'Subscriber', id: string } | null };
...
export type GetLessonsQuery = { __typename?: 'Query', lessons: Array<{ __typename?: 'Lesson', slug: string, title: string, id: string, availableAt?: any | null, lessonType: LessonType }> };


export const CreteSubscribeDocument = gql`
    mutation CreteSubscribe($name: String!, $email: String!) {
  createSubscriber(data: {name: $name, email: $email}) {
    id
  }
}
    `;
export type CreteSubscribeMutationFn = Apollo.MutationFunction<CreteSubscribeMutation, CreteSubscribeMutationVariables>;

/**
 * __useCreteSubscribeMutation__
 *
 * To run a mutation, you first call `useCreteSubscribeMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useCreteSubscribeMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [creteSubscribeMutation, { data, loading, error }] = useCreteSubscribeMutation({
 *   variables: {
 *      name: // value for 'name'
 ...
 * });
 */
export function useCreteSubscribeMutation(baseOptions?: Apollo.MutationHookOptions<CreteSubscribeMutation, CreteSubscribeMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<CreteSubscribeMutation, CreteSubscribeMutationVariables>(CreteSubscribeDocument, options);
      }
export type CreteSubscribeMutationHookResult = ReturnType<typeof useCreteSubscribeMutation>;
export type CreteSubscribeMutationResult = Apollo.MutationResult<CreteSubscribeMutation>;
export type CreteSubscribeMutationOptions = Apollo.BaseMutationOptions<CreteSubscribeMutation, CreteSubscribeMutationVariables>;
